...
export class Car {
  ...
  // Visual update: speed (m/s), steer (-1..1), brake, boost flags, slip angle (rad)
  animate (dt, speed, steer, braking, boosting, time) {
    this.wheelRot += speed * dt / 0.37
    for (const w of this.wheels) w.rotation.z = -this.wheelRot
